...
function keywordClassifier(text) {
  ...
  if (has("streetlight", "street light", "lamp", "bulb", "dark street")) return { category: "streetlight", reason: "keywords" }
  if (has("waterlogging", "water-logging", "flood", "drain", "stagnant", "sewage"))
    return { category: "water-logging", reason: "keywords" }
  return null
}
