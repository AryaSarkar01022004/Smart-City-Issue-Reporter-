  ...
  return (
    <main className="min-h-screen">
      ...
      <section id="report" className="mx-auto max-w-6xl px-4 py-8 sm:py-12">
        <div className="grid gap-8 lg:grid-cols-2">
          <Card className="border-emerald-100">
            <CardHeader>
              ...
              <CardDescription>{"Upload a photo, add details, and pick a location on the map."}</CardDescription>
            </CardHeader>
            <CardContent>
              <ReportForm
                onSubmitted={async () => {
        ...
        <div className="mt-8 flex items-center gap-3 rounded-lg border p-4 text-sm">
          <ShieldCheck className="h-4 w-4 text-emerald-600" />
          <p className="text-muted-foreground">
            {"This demo uses a Java Spring Boot API. Set NEXT_PUBLIC_API_BASE to your backend URL."}
          </p>
        </div>
      </section>
    </main>
