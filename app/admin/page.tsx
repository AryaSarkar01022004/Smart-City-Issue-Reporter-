...
const HeatmapMap = dynamic(() => import("@/components/heatmap-map"), { ssr: false })
    ...
    <main className="mx-auto max-w-6xl px-4 py-8 sm:py-12">
      ...
      <Card className="mt-6">
        <CardHeader>
          ...
          <CardDescription>{"Use filters to refine the view. Click markers to see details."}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="h-[520px] overflow-hidden rounded-lg border">
            <HeatmapMap reports={filtered} defaultCenter={{ lat: 28.6139, lng: 77.209 }} defaultZoom={11} />
          </div>

          <div className="text-xs text-muted-foreground">{"Map data © OpenStreetMap contributors"}</div>
        </CardContent>
      </Card>
      ...
      <Card className="mt-6">
        <CardHeader>
          ...
          <CardDescription>{"Filtered list of reports in view"}</CardDescription>
        </CardHeader>
        <CardContent>
          <ul className="divide-y">
            ...
            {filtered.length === 0 && (
              <li className="py-6 text-sm text-muted-foreground">{"No reports match the filters."}</li>
            )}
          </ul>
        </CardContent>
      </Card>
